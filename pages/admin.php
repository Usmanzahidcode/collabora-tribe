...
$query = "SELECT cp FROM users WHERE id = ?";
$stmt = $conn->prepare($query);
$stmt->bind_param('i', $_SESSION['user_id']);
$stmt->execute();
                    ...
                    <div class="tab-pane fade show active" id="nav-profile-info" role="tabpanel"
                        ...
                        <p class="fst-italic">Created on: <span><?php echo $user_date ?></span><span
                                    ...
                                    data-bs-custom-class="custom-popover" data-bs-content="This shows you activity on CollaboraTribe.
										The more acctive you are on the platform, the more points you have!">CP: <?php echo $cp; ?></span>
                        </p>
                        <p class=" fs-5">
                            <?php echo $user_bio ?>
                        </p>
                        ...
                        <form action="update-info.php" method="post" enctype="multipart/form-data">
							...
							<span class="input-group-text" id="addon-wrapping"><i
                                ...
                                <input name="name" type="text" class="form-control" placeholder="Full name"
                                       aria-label="Username"
                                       aria-describedby="addon-wrapping" required value="<?php echo $user_name ?>">
                            </div>
                            <div class="input-group mb-3">
                                <input name="email-half"
                                       ...
                                       aria-describedby="basic-addon2" required value="<?php echo rtrim($user_email, "@gmail.com"); ?>"/>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <textarea name="bio" class="form-control" aria-label="With textarea"
                                          ...
                                          rows="3"><?php echo $user_bio ?></textarea>
                            </div>
